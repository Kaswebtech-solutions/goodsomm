<nav class="mt-2">
    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
      ...
      <li class="nav-item">
        <a class="nav-link" href="#submenu1sub1" data-toggle="collapse" data-target="#submenu1sub1"><i class="fa fa-duotone fa-users nav-icon"></i><p>User Management</p><i class="fa fa-solid fa-chevron-right"></i></a>
